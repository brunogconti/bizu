...
Unit.where(["institution_id = ? OR institution_id = ? OR institution_id = ? OR institution_id = ? OR institution_id =? OR institution_id = ? OR institution_id = ? OR institution_id = ? OR institution_id = ? OR institution_id = ? OR institution_id = ? OR institution_id = ?", 2, 3, 17, 28, 29, 30, 31, 39, 40, 41, 42, 79]).each do |campus|
